  ...
  useEffect(() => {
    ...
    const staticData = {
      ...
      FullMenuData: [
        {
          name: "Món ăn 1",
          description: "Mô tả món ăn 1",
          price: "15.99"
        },
        {
          name: "Món ăn 2",
          description: "Mô tả món ăn 2", 
          price: "25.99"
        },
        {
          name: "Món ăn 3",
          description: "Mô tả món ăn 3",
          price: "35.99"
        }
      ]
    }
    
    setGalleryImages(staticData.CollectionData)
    setFullMenu(staticData.FullMenuData)
    setLoading(false)
  }, [])
